...
import can_img from "../../img/cannot.svg";
    ...
    <div className="completed">
      <div className="container">
        ...
        <div className="text_block">
          <h3>ТТ10, химки перед фантаном, только бб, без голды и фугасов</h3>
          <p className="create_text">Создано сегодня, 13:10</p>
          <p className="dota_text">Категория “World of Tanks”</p>
        </div>
        ...
        <div className="comple">
          ...
          <p className="comp_text">
            Статус:<span className="comp">Завершен</span>
          </p>
        </div>
        ...
        <div className="tron">
          ...
          <div className="f_block">
            ...
            <div className="f_lane2">Азим appass1nato Д.</div>
          </div>
        </div>
      </div>
    </div>
