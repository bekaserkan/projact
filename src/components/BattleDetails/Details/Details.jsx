...
import { RespondData } from "../../Respond/RespondData";
  ...
  return (
    <div className="details">
      <div className="contant">
        <h1>Dota 2, Играем на SF, мид до 2 смертей или до падения т1</h1>
        <p style={{ color: "#B5B5B5" }}>Создано сегодня, 13:10</p>
        <p style={{ color: "#C644CB" }}>Категория “Dota 2”</p>
      </div>
      <div className="wrapper">
        <p style={{ color: "#B5B5B5" }}>
          ...
          expedita deserunt. Nostrum quis nihil eligendi neque corporis modi ut?
        </p>
        <div className="save">
          <p style={{ color: "#FFFFFF" }}>Игра начинается: 20:00, 05.06.21</p>
          <p style={{ color: "#FFFFFF" }}>
            Ставка: <span style={{ color: "#FFB156" }}>1000 сом</span>
          </p>
          <p className="p">
            <img className="i" src={eye} /> 562 просмотров
          </p>
          <p className="p">
            <img className="i" src={revers} /> 18 предложений
          </p>
          <button onClick={errorClick} className="res">
            Редактировать
          </button>
        </div>
      </div>
      ...
      <div className="exp">Отменить задание</div>
      <div className="data">
        {RespondData.map((el) => (
